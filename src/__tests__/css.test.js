...
describe('css', () => {
    ...
    it('args: function', () => {
        ...
        expect(hash).toBeCalledWith(incoming, 'getSheet()', undefined, undefined, undefined, undefined);
        expect(compile).not.toBeCalled();
        expect(getSheet).toBeCalled();
        expect(out).toEqual('hash()');
    });
    ...
    it('bind', () => {
        ...
        expect(hash).toBeCalledWith('compile()', 'getSheet()', true, undefined, undefined, undefined);
