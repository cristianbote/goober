 ...
 * @summary Returns a function call for css function scaleX() with the passed in argmunets comma delimited
 *
 * @description
 * Returns a comma delimited function call for the css function scaleX()
 *
