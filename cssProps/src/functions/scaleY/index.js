 ...
 * @summary Returns a function call for css function scaleY() with the passed in argmunets comma delimited
 *
 * @description
 * Returns a comma delimited function call for the css function scaleY()
 *
