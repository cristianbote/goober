/* Do not modify this file.  This file is generated from ./cssProps/templates/props.test.mustache */
...
describe('cssProps', () => {
    ...
    it('animationIterationCount', () => {
        expect(cssProps.animationIterationCount('value')).toEqual({
    ...
    it('animationTimingFunction', () => {
        expect(cssProps.animationTimingFunction('value')).toEqual({
    ...
    it('borderBottomLeftRadius', () => {
        expect(cssProps.borderBottomLeftRadius('value')).toEqual({
    ...
    it('borderBottomRightRadius', () => {
        expect(cssProps.borderBottomRightRadius('value')).toEqual({
    ...
    it('borderInlineStartColor', () => {
        expect(cssProps.borderInlineStartColor('value')).toEqual({
    ...
    it('borderInlineStartStyle', () => {
        expect(cssProps.borderInlineStartStyle('value')).toEqual({
    ...
    it('borderInlineStartWidth', () => {
        expect(cssProps.borderInlineStartWidth('value')).toEqual({
    ...
    it('borderStartStartRadius', () => {
        expect(cssProps.borderStartStartRadius('value')).toEqual({
    ...
    it('caret type', () => {
        expect(typeof cssProps.caret).toEqual('function');
    });

    it('caret', () => {
        expect(cssProps.caret('value')).toEqual({ caret: 'value' });
    });
    it('caretColor type', () => {
    ...
    it('caretShape type', () => {
        expect(typeof cssProps.caretShape).toEqual('function');
    });

    it('caretShape', () => {
        expect(cssProps.caretShape('value')).toEqual({ caretShape: 'value' });
    });
    it('clear type', () => {
    ...
    it('printColorAdjust type', () => {
        expect(typeof cssProps.printColorAdjust).toEqual('function');
    });

    it('printColorAdjust', () => {
        expect(cssProps.printColorAdjust('value')).toEqual({ printColorAdjust: 'value' });
    });
    it('colorScheme type', () => {
    ...
    it('hyphenateCharacter type', () => {
        expect(typeof cssProps.hyphenateCharacter).toEqual('function');
    });

    it('hyphenateCharacter', () => {
        expect(cssProps.hyphenateCharacter('value')).toEqual({ hyphenateCharacter: 'value' });
    });
    it('hyphenateLimitChars type', () => {
        expect(typeof cssProps.hyphenateLimitChars).toEqual('function');
    });

    it('hyphenateLimitChars', () => {
        expect(cssProps.hyphenateLimitChars('value')).toEqual({ hyphenateLimitChars: 'value' });
    });
    it('hyphens type', () => {
    ...
    it('inputSecurity type', () => {
        expect(typeof cssProps.inputSecurity).toEqual('function');
    });

    it('inputSecurity', () => {
        expect(cssProps.inputSecurity('value')).toEqual({ inputSecurity: 'value' });
    });
    it('inset type', () => {
    ...
    it('mathDepth type', () => {
        expect(typeof cssProps.mathDepth).toEqual('function');
    });

    it('mathDepth', () => {
        expect(cssProps.mathDepth('value')).toEqual({ mathDepth: 'value' });
    });
    it('mathShift type', () => {
        expect(typeof cssProps.mathShift).toEqual('function');
    });

    it('mathShift', () => {
        expect(cssProps.mathShift('value')).toEqual({ mathShift: 'value' });
    });
    it('mathStyle type', () => {
    ...
    it('overscrollBehaviorBlock', () => {
        expect(cssProps.overscrollBehaviorBlock('value')).toEqual({
    ...
    it('overscrollBehaviorInline', () => {
        expect(cssProps.overscrollBehaviorInline('value')).toEqual({
    ...
    it('scrollMarginBlockStart', () => {
        expect(cssProps.scrollMarginBlockStart('value')).toEqual({
    ...
    it('scrollMarginInlineStart', () => {
        expect(cssProps.scrollMarginInlineStart('value')).toEqual({
    ...
    it('scrollPaddingBlockStart', () => {
        expect(cssProps.scrollPaddingBlockStart('value')).toEqual({
    ...
    it('scrollPaddingInlineStart', () => {
        expect(cssProps.scrollPaddingInlineStart('value')).toEqual({
    ...
    it('scrollPaddingInlineEnd', () => {
        expect(cssProps.scrollPaddingInlineEnd('value')).toEqual({
    ...
    it('textDecorationThickness', () => {
        expect(cssProps.textDecorationThickness('value')).toEqual({
    ...
    it('transitionTimingFunction', () => {
        expect(cssProps.transitionTimingFunction('value')).toEqual({
