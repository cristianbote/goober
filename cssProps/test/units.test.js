/* Do not modify this file.  This file is generated from ./cssProps/templates/units.test.mustache */
import * as cssUnits from '../src/units/index';
import { css, setup } from 'goober';

describe('cssUnits', () => {
    it('cap type', () => {
        expect(typeof cssUnits.cap).toEqual('function');
    });

    it('cap', () => {
        expect(cssUnits.cap(5)).toEqual('5cap');
    });
    it('ch type', () => {
    ...
    it('ic type', () => {
        expect(typeof cssUnits.ic).toEqual('function');
    });

    it('ic', () => {
        expect(cssUnits.ic(5)).toEqual('5ic');
    });
    it('inch type', () => {
    ...
    it('in', () => {
        expect(cssUnits.inch(5)).toEqual('5in');
    });
    it('kHz type', () => {
