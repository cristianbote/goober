/* Do not modify this file.  This file is generated from ./cssProps/templates/functions.test.mustache */
import * as cssFunctions from '../src/functions/index';
...
describe('cssFunctions', () => {
    ...
    it('repeatingLinearGradient', () => {
        expect(cssFunctions.repeatingLinearGradient(255, 255)).toEqual(
            'repeatingLinearGradient(255,255)'
        );
    });
    ...
    it('repeatingRadialGradient', () => {
        expect(cssFunctions.repeatingRadialGradient(255, 255)).toEqual(
            'repeatingRadialGradient(255,255)'
        );
    });
    it('rgb type', () => {
